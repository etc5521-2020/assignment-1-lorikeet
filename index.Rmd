...
school_vs_overall %>%
  ...
  mutate(school_overall_rate = percent(school_overall_rate/100))%>%
  kable(col.names = c("Type",
                      "School MMR Vaccination Rate","school overall Vaccination Rate"),
        # add a caption
        caption = "School MMR Vaccination Rate vs School Overall Vaccination Rate",
        align = c("l","r")) %>%
  kable_styling()
```
