...
measles_education_wide <- measles_education %>% 
  pivot_wider(names_from = variable_description,
              values_from = estimate) %>% 
  clean_names()%>%
  mutate(bachelor_prop = bachelor_degree/total_population,
         highschool_prop = high_school_graduates/total_population,
         less_highschool_prop = less_than_high_school_graduates/total_population)
```
