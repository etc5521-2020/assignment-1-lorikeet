...
The difference in schools' overall vaccination rates and MMR vaccination rates will be examined in this section.
...
In this section, the report will perform a comparative analysis between school's 2018/2019 MMR and overall vaccination rates in USA. The summary of this comparison are shown in Table \@ref(tab:vacc-diff-table). Compared to the previous section, the table only reflects three school types. This is due to the fact that only three types of school that have observations of vaccination rates for both MMR and overall vaccination rates in the WSJ dataset. Table \@ref(tab:vacc-diff-table) shows that kindergartens have 6.21% difference in MMR and overall vaccination rates. In contrast, private and public schools have similar MMR and overall vaccination rates.
